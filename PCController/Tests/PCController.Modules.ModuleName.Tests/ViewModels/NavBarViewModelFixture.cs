using Moq;
using PCController.Modules.Navigation.ViewModels;
using PCController.Services.Interfaces;
using Prism.Regions;
using Xunit;

namespace PCController.Modules.Navigation.Tests.ViewModels
{
    public class NavBarViewModelFixture
    {
